...
gb1 <- combine$data.unit == "GB" & combine$expiry == 1

# CHECK SELECTION BEFORE
#combine[gb1, ]

# slice df by "GB" and "1" rows and assign new units and amounts
combine[gb1, ]$data.amount <- (combine[gb1, ]$data.amount * 1000)
combine[gb1, ]$data.unit <- "MB"
...
mb7 <- combine$data.unit == "MB" & combine$expiry == 7

# CHECK SELECTION BEFORE
#combine[mb7, ]

# slice df by "MB" and "7" rows and assign new units and amounts
combine[mb7, ]$data.amount <- (combine[mb7, ]$data.amount / 1000)
combine[mb7, ]$data.unit <- "GB"
...
# logical vector of rows with "MB" as data unit and 30 as expiry
mb30 <- combine$data.unit == "MB" & combine$expiry == 30

# CHECK SELECTION BEFORE
#combine[mb30, ]

# slice df by "MB" and "30" rows and assign new units and amounts
combine[mb30, ]$data.amount <- (combine[mb30, ]$data.amount / 1000)
combine[mb30, ]$data.unit <- "GB"
